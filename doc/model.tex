...
& \implies \\
x^\top \eta & \leq  x^\top \eta^0 + \dotprod{ x, \eta -\eta^0  } 
\end{align*}
So it is true but also vacuously so? What is now the point of mapping back to $\theta$ and looking at the resulting bound? It does not seem informative.
